...
import type { PRRecord, MockUser, MockPR } from '@/types';

// Re-export types for convenience
export type { MockUser, MockPR };
...
export const mockPRs: MockPR[] = [
  {
    ...
    repo_name: 'cal.com',
    title:
      'bug: AI assistant button overlaps bottom navigation and poor padding on Teams page (mobile)',
    status: 'completed',
  ...
  },
  {
    ...
    repo_name: 'supabase',
    title:
      '404 page - Improve documentation link on Getting Started page for Realtime',
    status: 'pending',
