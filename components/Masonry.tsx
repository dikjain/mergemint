  ...
  return (
    <div ref={containerRef} className="relative w-full h-full">
      {grid.map((item) => (
        ...
        >
          <div
            className="relative w-full h-full bg-cover bg-center rounded-[10px] shadow-[0px_10px_50px_-10px_rgba(0,0,0,0.2)] object-bottom uppercase text-[10px] leading-[10px]"
