...
export default function EmptyPrs() {
  return (
    ...
    <div className="w-full relative h-full">
        <div className='absolute w-full h-full flex items-center justify-center z-30'>
            <Image 
                ...
                fill
                objectFit='contain'
                style={{transform : 'translateX(-20%)', scale : '0.8',opacity : '0.9'}}
            />
            <h1   style={{transform : 'translateX(20%)'}}
className='text-6xl font-bold text-neutral-700 font-nunito'>MAKE PR,<br /> EARN NFTs</h1>
        </div>
